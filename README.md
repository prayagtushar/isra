...
**[Try the live demo →](https://isra.prayagtushar.xyz)** There is no landing page and no account. The site opens straight into the chat. Ask a question, watch the pipeline resolve stage by stage in [`/lab`](https://isra.prayagtushar.xyz/lab), or browse [`/search`](https://isra.prayagtushar.xyz/search) and [`/startups`](https://isra.prayagtushar.xyz/startups). Only re-ingesting the corpus is gated, by a shared key.
...
are visible in [`/lab`](https://isra.prayagtushar.xyz/lab), which is how the
